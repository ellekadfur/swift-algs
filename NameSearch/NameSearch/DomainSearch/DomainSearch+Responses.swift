...
extension DomainSearchViewController {
    public struct ExactMatchResponse: Codable {
        ...
        public let products: [ProductResponse]
        ...
        public init(products: [ProductResponse], domain: ExactMatch) {
    ...
    public struct RecommendedResponse: Codable {
        ...
        public init(products: [ProductResponse], domains: [RecommendedDomain]) {
            self.products = products
